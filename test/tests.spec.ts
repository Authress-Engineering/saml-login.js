  ...
  describe("saml.js / ", function () {
    ...
    it("_generateLogoutRequest", function (done) {
      try {
        ...
        const samlObj = new SAML({ providerSingleSignOnUrl: "foo", cert: FAKE_CERT });
      ...
      describe("validatePostResponse xml signature checks /", function () {
        ...
        it("multiple certs should validate with one of the certs", async () => {
          const multiCertSamlConfig = {
            providerSingleSignOnUrl: samlConfig.providerSingleSignOnUrl,
    ...
    describe("getAuthorizeUrl request signature checks /", function () {
      ...
      it("acme_tools request signed with sha256", async () => {
        const samlConfig: SamlConfig = {
          providerSingleSignOnUrl: "https://adfs.acme_tools.com/adfs/ls/",
      ...
      it("acme_tools request not signed if missing entry point", async () => {
        ...
        await assert.rejects(samlObj._requestToUrlAsync(request, null, "authorize", {}), {
          message: "providerSingleSignOnUrl is required",
        });
      });
...
<ds:KeyInfo><ds:X509Data><ds:X509Certificate></ds:X509Certificate></ds:X509Data></ds:KeyInfo></ds:Signature>
  ...
  it("errors if bad privateKey to requestToURL", async () => {
    const samlObj = new SAML({
      providerSingleSignOnUrl: "http://localhost",
      privateKey:
        "-----BEGIN CERTIFICATE-----\n" +
  ...
  describe("validateRedirect()", function () {
    describe("idp slo", function () {
      ...
      beforeEach(function () {
        samlObj = new SAML({
          ...
          expectedProviderIssuer: "http://localhost:20000/saml2/idp/metadata.php",
        });
      ...
      it("errors if expectedProviderIssuer is set and issuer is wrong", async function () {
        samlObj.options.expectedProviderIssuer = "foo";
    ...
    describe("sp slo", function () {
      ...
      it("errors if expectedProviderIssuer is set and wrong issuer", async function () {
        samlObj.options.expectedProviderIssuer = "foo";
        await assert.rejects(
          samlObj.validateRedirectAsync(this.request, this.request.originalQuery),
          {
